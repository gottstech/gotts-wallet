...
use gotts_wallet_util::LoggingConfig;

/// Wallet configuration file name
pub const WALLET_CONFIG_FILE_NAME: &'static str = "gotts-wallet.toml";
const WALLET_LOG_FILE_NAME: &'static str = "gotts-wallet.log";
const GOTTS_HOME: &'static str = ".gotts";
/// Wallet data directory
pub const GOTTS_WALLET_DIR: &'static str = "wallet_data";
/// API secret
pub const API_SECRET_FILE_NAME: &'static str = ".api_secret";

fn get_gotts_path(chain_type: &global::ChainTypes) -> Result<PathBuf, ConfigError> {
...
fn check_api_secret_file(chain_type: &global::ChainTypes) -> Result<(), ConfigError> {
	let gotts_path = get_gotts_path(chain_type)?;
...
impl GlobalWalletConfig {
	...
	pub fn update_paths(&mut self, wallet_home: &PathBuf) {
		...
		wallet_path.push(GOTTS_WALLET_DIR);

...
use crate::gotts_core::core::{Output, TxKernel};
use crate::gotts_core::libtx::secp_ser;
use crate::gotts_keychain::Identifier;
...
pub struct InitTxArgs {
	...
	/// [`set_active_account`](../gotts_wallet_api/owner/struct.Owner.html#method.set_active_account) method.
	pub src_acct_name: Option<String>,
	#[serde(with = "secp_ser::string_or_u64")]
	/// The amount to send, in nanogottss. (`1 G = 1_000_000_000nG`)
	pub amount: u64,
	#[serde(with = "secp_ser::string_or_u64")]
...
pub struct IssueInvoiceTxArgs {
	...
	/// The invoice amount in nanogottss. (`1 G = 1_000_000_000nG`)
	#[serde(with = "secp_ser::string_or_u64")]
	pub amount: u64,
	/// Optional message, that will be signed
	pub message: Option<String>,
